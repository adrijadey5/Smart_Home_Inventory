...
const firebaseConfig = {
    "projectId": "studio-4130048149-edac7",
    "appId": "1:315477404307:web:7e4e36da202b2b8c8abb66",
    "apiKey": "AIzaSyAqKmAzNFtGWkqODtxG-sQncXqVb4-UWTM",
    "authDomain": "studio-4130048149-edac7.firebaseapp.com",
    "measurementId": "",
    "messagingSenderId": "315477404307"
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
const useUser = ()=>{
    _s();
    const { user, isUserLoading, userError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"])(); // Leverages the main hook
    return {
        user,
        isUserLoading,
        userError
...
_s(useUser, "huZTQEv0vojfA8ahUwgbOjgU01Y=", false, function() {
    return [
...
//# sourceMappingURL=src_1e072e05._.js.map