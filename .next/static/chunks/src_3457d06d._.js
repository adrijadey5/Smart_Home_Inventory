...
function HomeStockLayout() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomeStockLayout.useEffect": ()=>{
            try {
                ...
                if (storedInventory) {
                    const parsed = JSON.parse(storedInventory).map({
                        "HomeStockLayout.useEffect.parsed": (item)=>({
                                ...item,
                                expiryDate: item.expiryDate ? new Date(item.expiryDate) : undefined
                            })
                    }["HomeStockLayout.useEffect.parsed"]);
                    setInventory(parsed);
                } else {
                    setInventory(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_INVENTORY"]);
                }
            } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomeStockLayout.useEffect": ()=>{
            ...
            if (!lastCheck || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSameDay"])(today, lastCheck)) {
                const recurringItems = inventory.filter({
                    "HomeStockLayout.useEffect.recurringItems": (i)=>i.isRecurring
                }["HomeStockLayout.useEffect.recurringItems"]);
                if (recurringItems.length > 0) {
                    toast({
                        title: "Recurring Items Reminder",
                        description: `Remember to check stock for: ${recurringItems.map({
                            "HomeStockLayout.useEffect": (i)=>i.name
                        }["HomeStockLayout.useEffect"]).slice(0, 3).join(', ')}.`
                    });
                }
...
_s(HomeStockLayout, "CnFZgmUM1vMh5zIe88+ewehPHfM=", false, function() {
    return [
...
//# sourceMappingURL=src_3457d06d._.js.map